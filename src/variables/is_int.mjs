 ...
 * ### Параметры
 *
 * - `value` (any): Значение, которое нужно проверить.
 *
 * ### Описание
 *
...
export default function is_int(value) {
    return (
        typeof value === 'number' && // Проверка типа на число
        Number.isFinite(value) && // Убеждение, что число конечное
        value % 1 === 0 // Проверка остатка от деления на 1
    );
}
