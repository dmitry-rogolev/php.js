export { default as get_magic_proxy } from './functions/get_magic_proxy.mjs';
export { default as get_property_descriptor } from './functions/get_property_descriptor.mjs';
