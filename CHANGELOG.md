...
-   Добавлен модуль [class](./docs/funcref/vartype/class.md) со следующими функциями:
    ...
    -   [get_class](./docs/funcref/vartype/class/get_class.md) &mdash; Возвращает класс, которому
        принадлежит объект
    -   [get_class_methods](./docs/funcref/vartype/class/get_class_methods.md) &mdash; Возвращает
        массив имён методов класса
    ...
    -   [get_parent_class](./docs/funcref/vartype/class/get_parent_class.md) &mdash; Получает имя
        родительского класса для объекта или класса
...
-   Добавлен модуль [array](./docs/funcref/vartype/array.md), содержащий следующие функции:
    ...
    -   [arsort](./docs/funcref/vartype/array/func/arsort.md) &mdash; Сортирует массив в порядке
        убывания, сохраняя ассоциацию индексов
    -   [asort](./docs/funcref/vartype/array/func/asort.md) &mdash; Сортирует массив в порядке
        возрастания, сохраняя ассоциацию индексов
    ...
    -   [key_exists](./docs/funcref/vartype/array/func/key_exists.md) &mdash; Псевдоним
        `array_key_exists`
    -   [krsort](./docs/funcref/vartype/array/func/krsort.md) &mdash; Сортирует массив по ключу в
        порядке убывания
